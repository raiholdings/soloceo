...
class CSRFMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next: Callable[[Request], Awaitable[Response]]) -> Response:
        ...
        # SoloCEO v2: caller nội bộ tin cậy (X-DeerFlow-Internal-Token hợp lệ) được
        # miễn CSRF — dùng cho HITL resume từ api-core. Auth middleware đã tin token
        # này (auth_middleware.dispatch); CSRF double-submit cookie chỉ dành cho
        # trình duyệt, không áp dụng cho server-to-server.  # internal_bypass
