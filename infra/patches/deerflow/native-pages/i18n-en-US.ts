...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to 🦌 SoloCEO AI, an open source super agent. With built-in and custom skills, SoloCEO AI helps you search on the web, analyze data, and generate artifacts like slides, web pages and do almost anything.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of SoloCEO AI. With customized skills,\nSoloCEO AI can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  // Input Box
  inputBox: {
    placeholder: "Hôm nay em có thể giúp gì cho anh/chị?",
    createSkillPrompt:
    ...
    suggestions: [
      {
        suggestion: "Khởi tạo ý tưởng",
        prompt:
          "Tôi có ý tưởng: [mô tả ý tưởng của bạn]. Hãy dùng MCP soloceo-bigdata (tra_cuu_du_lieu, phan_tich_y_tuong) để đối chiếu ý tưởng này với kho dữ liệu Data Engine — vấn đề đang xảy ra, giải pháp đã có, mô hình kinh doanh đã có, sản phẩm đã có, sự kiện đang diễn ra — rồi dựng cho tôi Business Model Canvas 9 khối + lộ trình triển khai. Nếu kho chưa có dữ liệu khớp thì nói thẳng.",
        icon: SparklesIcon,
      },
      {
        suggestion: "CRM",
        prompt:
          "Dùng MCP soloceo-crm thao tác trực tiếp CRM của tôi: crm_summary để xem tổng quan, crm_list_leads và crm_list_invoices mới nhất, rồi đề xuất 3 việc cần làm hôm nay. Hỏi tôi trước khi tạo/sửa dữ liệu.",
        icon: Building2Icon,
      },
      {
        suggestion: "Thị trường",
        prompt:
          "Dùng MCP soloceo-marketplace kiểm tra các kênh bán đã kết nối của tôi (sản phẩm, đơn hàng, tồn kho) và báo cáo tình hình + việc cần xử lý.",
        icon: ShoppingCartIcon,
      },
      {
        suggestion: "Hệ sinh thái",
        prompt:
          "Dùng MCP soloceo-ecosystem: ecosystem_catalog để xem các nền tảng tôi đang có, rồi ecosystem_plan cho mục tiêu: [mục tiêu kinh doanh của bạn] — lập kế hoạch tận dụng các nền tảng lõi và thực thi giúp tôi.",
        icon: LayoutGridIcon,
      },
      {
        suggestion: "Dữ liệu",
        prompt:
          "Dùng MCP soloceo-bigdata tra cứu giúp tôi: [từ khoá/ngành/thị trường]. Tổng hợp doanh nghiệp, startup thành công, xu hướng và cơ hội cho doanh nghiệp một người tại Việt Nam.",
        icon: DatabaseIcon,
      },
      {
        suggestion: "Tạo doanh nghiệp",
        prompt:
          "Tôi muốn khởi tạo doanh nghiệp một người trên SoloCEO. Hãy tư vấn cho tôi từ ý tưởng đến khi khởi tạo: [mô tả ý tưởng kinh doanh của bạn]",
        icon: RocketIcon,
      },
    ],
    suggestionsCreate: [
      {
        suggestion: "Đào tạo",
        prompt:
          "Dùng MCP soloceo-ecosystem (edu_recommend) gợi ý khoá học SoloCEO phù hợp với tôi về chủ đề: [chủ đề], rồi tóm tắt lộ trình học.",
        icon: GraduationCapIcon,
      },
      {
        suggestion: "Cộng đồng",
        prompt:
          "Dùng MCP soloceo-ecosystem (community_draft_post) soạn bài đăng cộng đồng về: [chủ đề], mục tiêu thu hút khách hàng. Cho tôi duyệt trước khi đăng.",
        icon: Users2Icon,
      },
      {
        suggestion: "Video",
        prompt:
          "Dùng MCP soloceo-ecosystem (video_plan) lập kịch bản video ngắn về: [chủ đề] để bán hàng.",
        icon: VideoIcon,
      },
      {
        suggestion: "Họp video",
        prompt:
          "Dùng MCP soloceo-ecosystem (meeting_create) tạo phòng họp cho: [chủ đề cuộc họp] rồi gửi tôi đường dẫn.",
        icon: VideoIcon,
      },
      { type: "separator" },
      {
        suggestion: "Hoá đơn & Thuế",
        prompt:
          "Tôi cần xử lý hoá đơn và thuế. Hướng dẫn tôi dùng công cụ Hoá đơn & Thuế của SoloCEO (thue.crm.soloceo.vn): tính hoá đơn, đối chiếu quý, soạn tờ khai. Nhắc rõ ranh giới: SoloCEO chỉ soạn thảo, tôi tự phát hành qua nhà cung cấp được cấp phép và tự nộp bằng chữ ký số.",
        icon: ReceiptIcon,
      },
      {
        suggestion: "Lập doanh nghiệp",
        prompt:
          "Tôi muốn thành lập doanh nghiệp. Hướng dẫn tôi dùng công cụ Lập doanh nghiệp (dkkd.crm.soloceo.vn) để soạn bộ hồ sơ và nộp trên Cổng ĐKKD quốc gia. Nêu rõ các bước và giấy tờ cần chuẩn bị.",
        icon: Building2Icon,
      },
      {
        suggestion: "Sàn M&A",
        prompt:
          "Tôi quan tâm Sàn M&A của SoloCEO. Giải thích điều kiện niêm yết doanh nghiệp (doanh thu đã xác thực) và giúp tôi chuẩn bị hồ sơ.",
        icon: LandmarkIcon,
      },
      {
        suggestion: "Affiliate",
        prompt:
          "Tôi muốn chạy chương trình tiếp thị liên kết cho sản phẩm của mình trên aff.soloceo.vn. Tư vấn cơ cấu hoa hồng và cách tuyển cộng tác viên.",
        icon: HandshakeIcon,
      },
      {
        suggestion: "Đọc tài liệu",
        prompt: "Đọc và tóm tắt tài liệu tôi đính kèm, rút ra các việc cần làm.",
        icon: ScanTextIcon,
      },
      {
        suggestion: "Duyệt web AI",
        prompt: "Duyệt web giúp tôi và tổng hợp thông tin về: [chủ đề].",
        icon: ScanEyeIcon,
      },
    ],
  ...
  sidebar: {
    ...
    demoChats: "Trò chuyện mẫu",
    agents: "Trợ lý AI",
    scheduledTasks: "Việc theo lịch",
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. SoloCEO AI is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but SoloCEO AI could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "SoloCEO AI's official website",
    githubTooltip: "SoloCEO AI on GitHub",
    settingsAndMore: "Settings and more",
    visitGithub: "SoloCEO AI on GitHub",
    reportIssue: "Report an issue",
    contactUs: "Contact us",
    about: "About SoloCEO AI",
    logout: "Log out",
  ...
  channels: {
    ...
    descriptions: {
      telegram: "Telegram direct messages through your SoloCEO AI bot.",
      slack: "Slack workspace messages and mentions.",
      discord: "Discord server messages through your SoloCEO AI bot.",
      feishu: "Feishu and Lark messages through your SoloCEO AI app.",
      dingtalk: "DingTalk Stream Push messages through your SoloCEO AI bot.",
      wechat: "WeChat iLink messages through your SoloCEO AI bot.",
      wecom: "WeCom messages through your SoloCEO AI AI bot.",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to SoloCEO AI",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate SoloCEO AI faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how SoloCEO AI looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "SoloCEO AI automatically learns from your conversations in the background. These memories help SoloCEO AI understand you better and deliver a more personalized experience.",
    ...
    channels: {
      title: "Channels",
      description:
        "Connect IM accounts that can send messages to SoloCEO AI from outside the browser.",
      disabled:
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of SoloCEO AI.",
    ...
    notification: {
      title: "Notification",
      description:
        "SoloCEO AI only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
      requestPermission: "Request notification permission",
      deniedHint:
        "Notification permission was denied. You can enable it in your browser's site settings to receive completion alerts.",
      testButton: "Send test notification",
      testTitle: "SoloCEO AI",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "This account signs in with {provider}, so SoloCEO AI cannot manage or change its password here. Use your SSO provider's account settings instead.",
  ...
  login: {
    ...
    adminSetupRequiredDescription:
      "SoloCEO AI needs an administrator account before new regular accounts can be created.",
